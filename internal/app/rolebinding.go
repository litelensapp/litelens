...
func (a *App) ListRoleBindings(namespace string) ([]dto.RoleBinding, error) {
	a.mu.RLock()
	h := a.factories[a.activeContext]
	a.mu.RUnlock()
	if h == nil {
...
func (a *App) emitRoleBindings(namespace string) {
	a.mu.RLock()
	h := a.factories[a.activeContext]
	a.mu.RUnlock()
	if h == nil {
	...
	allData, err := kubeResources.ListRoleBindings(lister, "")
	if err != nil {
