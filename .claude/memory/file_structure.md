...
/go.mod               # module github.com/gknguyen/litelens (root/main module); no longer requires or replaces github.com/gknguyen/litelens/plugins/helm (that require+replace was removed 2026-08-01 along with built-in Helm — plugins/helm is a fully standalone module now, root module has zero knowledge of it, see [[gotcha_generic_plugin_grpc_boundary]])
/go.sum
