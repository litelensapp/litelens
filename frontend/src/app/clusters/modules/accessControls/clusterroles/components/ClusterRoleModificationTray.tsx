import { useGetClusterRoleYAML } from "../hooks/data-access/useGetClusterRoleYAML";
import { useUpdateClusterRoleYAML } from "../hooks/data-mutation/useUpdateClusterRoleYAML";
...
export const ClusterRoleModificationTray: FC<ModificationTrayContentProps> = ({
  tab,
  collapsed,
  onClose,
}) => {
  ...
  const clusterRoleName = tab.name;
  ...
  } = useGetClusterRoleYAML(activeContext, clusterRoleName);
  ...
  const { mutate: updateYAML, isPending: isUpdating } = useUpdateClusterRoleYAML();
