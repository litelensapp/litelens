...
export const PersistentVolumeClaimModificationTray: FC<ModificationTrayContentProps> = ({
  tab,
  collapsed,
  onClose,
}) => {
  ...
  } = useGetPersistentVolumeClaimYAML(activeContext, namespace, pvcName);

  const { mutate: updateYAML, isPending: isUpdating } = useUpdatePersistentVolumeClaimYAML();
