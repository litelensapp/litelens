...
import { useGetSecretYAML } from "../hooks/data-access/useGetSecretYAML";
import { useUpdateSecretYAML } from "../hooks/data-mutation/useUpdateSecretYAML";
...
export const SecretModificationTray: FC<ModificationTrayContentProps> = ({
  tab,
  collapsed,
  onClose,
}) => {
  ...
  } = useGetSecretYAML(activeContext, namespace, secretName);

  const { mutate: updateYAML, isPending: isUpdating } = useUpdateSecretYAML();
