...
import { useGetLimitRangeYAML } from "../hooks/data-access/useGetLimitRangeYAML";
import { useUpdateLimitRangeYAML } from "../hooks/data-mutation/useUpdateLimitRangeYAML";
...
export const LimitRangeModificationTray: FC<ModificationTrayContentProps> = ({
  tab,
  collapsed,
  onClose,
}) => {
  ...
  } = useGetLimitRangeYAML(activeContext, namespace, limitRangeName);

  const { mutate: updateYAML, isPending: isUpdating } = useUpdateLimitRangeYAML();
