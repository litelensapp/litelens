...
import { useGetValidatingWebhookConfigYAML } from "../hooks/data-access/useGetValidatingWebhookConfigYAML";
import { useUpdateValidatingWebhookConfigYAML } from "../hooks/data-mutation/useUpdateValidatingWebhookConfigYAML";
...
export const ValidatingWebhookConfigModificationTray: FC<ModificationTrayContentProps> = ({
  tab,
  collapsed,
  onClose,
}) => {
  ...
  } = useGetValidatingWebhookConfigYAML(activeContext, vwcName);
  ...
  const { mutate: updateYAML, isPending: isUpdating } = useUpdateValidatingWebhookConfigYAML();
